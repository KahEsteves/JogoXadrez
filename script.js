...
/*símbolos do xadrez*/
    ...
    /*estabelecendo as cores das caixas onde os icones estarão*/
    function updateSquarecolor(){
        for(var n = 0; n < 64; n++){
            if(Math.floor(n/8)%2 === 0){
                if(n%2 === 0){
                    sqs[n].style.background = '#B9F3FC';
                }
                else {
                    sqs[n].style.background = '#E5FDD1';
                }
            }
            else {
                if(n%2 === 1){
    ...
    //    alert(effects)
        ...
        /*Se as jogadas estiverem corretas, voce vencera!*/
        else {
            //alert('Você venceu');
        }
    }
